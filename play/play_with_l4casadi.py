...
size_in = 2
size_out = 1
l4c_model = l4c.realtime.RealTimeL4CasADi(
    pyTorch_model, approximation_order=1
...
casadi_out = casadi_func(
    x.transpose((-2, -1)), casadi_param
)  # transpose for vector rep. expected by casadi
